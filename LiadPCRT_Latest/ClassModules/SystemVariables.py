    ...
    def Init(self):
        try:
            ...
            while not RstData.EOF:
                select_variable_0 = adoFunc.adoFunc.fGetRstValString(RstData["FieldName"])
                if (select_variable_0 == 'CycleTimeCalc'):
                    select_variable_1 = adoFunc.adoFunc.fGetRstValString(RstData["CValue"].upper())
                    ...
                    select_variable_2 = adoFunc.adoFunc.fGetRstValString('CValue').upper()
                    ...
                    select_variable_3 = adoFunc.adoFunc.fGetRstValString('CValue').upper()
                    ...
                    self.CavitiesEffFactor = adoFunc.fGetRstValDouble(RstData["CValue"])
                elif (select_variable_0 == 'CycleTimeEffFactor'):
                    self.CycleTimeEffFactor = adoFunc.fGetRstValDouble(RstData["CValue"])
                elif (select_variable_0 == 'MachineTimeEffFactor'):
                    self.MachineTimeEffFactor = adoFunc.fGetRstValDouble(RstData["CValue"])
                elif (select_variable_0 == 'RejectsEffFactor'):
                    self.RejectsEffFactor = adoFunc.fGetRstValDouble(RstData["CValue"])
                elif (select_variable_0 == 'ChangeJobPath'):
                    self.ChangeJobPath = adoFunc.adoFunc.fGetRstValString(RstData["CValue"])
                elif (select_variable_0 == 'FirstDayOfWeek'):
                    select_variable_4 = adoFunc.adoFunc.fGetRstValString(RstData["CValue"].upper())
                    if (select_variable_4 == 'SUN'):
                        self.FirstDayOfWeek = vbSunday
                    elif (select_variable_4 == 'MON'):
                        self.FirstDayOfWeek = vbMonday
                elif (select_variable_0 == 'UnitsProducedLeftZero'):
                    select_variable_5 = adoFunc.adoFunc.fGetRstValString('CValue').upper()
                    ...
                    select_variable_6 = adoFunc.adoFunc.fGetRstValString('CValue').upper()
                    ...
                    self.HistoryEndIntervalMin = adoFunc.fGetRstValLong(RstData["CValue"])
                elif (select_variable_0 == 'HistoryIntervalMin'):
                    self.HistoryIntervalMin = adoFunc.fGetRstValLong(RstData["CValue"])
                    if self.HistoryEndIntervalMin == 0:
                        self.HistoryEndIntervalMin = 15
                elif (select_variable_0 == 'TotalEquipmentMaterialEfficencyOption'):
                    select_variable_7 = adoFunc.adoFunc.fGetRstValString(RstData["CValue"].upper())
                    ...
                    select_variable_8 = adoFunc.adoFunc.fGetRstValString(RstData["CValue"].upper())
                    ...
                    select_variable_9 = adoFunc.adoFunc.fGetRstValString(RstData["CValue"].upper())
                    ...
                    self.ReportInventoryItemMinAmount = adoFunc.fGetRstValDouble(RstData["CValue"])
                elif (select_variable_0 == 'AddPackageTypeToInventoryBatch'):
                    self.AddPackageTypeToInventoryBatch = adoFunc.fGetRstValBool(RstData["CValue"], False)
                elif (select_variable_0 == 'InventoryStatusOnCreation'):
                    self.InventoryStatusOnCreation = adoFunc.fGetRstValLong(RstData["CValue"])
                    if self.InventoryStatusOnCreation == 0:
                        self.InventoryStatusOnCreation = 1
                elif (select_variable_0 == 'HistoryIntervalSec'):
                    self.HistoryIntervalSec = adoFunc.fGetRstValLong(RstData["CValue"])
                elif (select_variable_0 == 'AllowEventReasonsWithNoDefinition'):
                    self.AllowEventReasonsWithNoDefinition = adoFunc.fGetRstValBool(RstData["CValue"], False)
                Rst.MoveNext()
            Rst.Close()
            Rst = None
